    ...
    <div className='w-2/3'>
      ...
      <div>
        ...
        <div className='flex flex-wrap gap-2'>
          {
            skills.map((item, index) => <ActionIcon key={index} color='brightSun.4' className='!h-fit !w-fit !text-sm font-medium ' p="xs" variant="light" radius="lg" aria-label="Settings">
              React
            </ActionIcon>)
          }
        </div>
      ...
      <div>
        ...
        <div className='flex justify-between  '>
          <div className='flex gap-2 items-center '>
            <div className='p-3 bg-mine-shaft-800 rounded-xl  '>
              <img className=' h-8 ' src={`/Icons/Google.png`} alt="ms" />
            </div>
          ...
          <div className='text-mine-shaft-300 text-justify'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magni ullam maiores quia, ratione sequi debitis, corrupti, ex quae fugit accusamus eaque in aspernatur. Harum et accusamus amet dolorum est quaerat voluptatum laudantium dicta facere, nulla magnam, facilis ipsa sint minima.</div>
