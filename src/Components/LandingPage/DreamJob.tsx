    ...
    return (
        ...
        <div className='flex items-center px-16  '>
            ...
            <div className='flex flex-col w-[45%] gap-3 '>
                ...
                <div className='text-lg text-mine-shaft-200 '>Good life vegins with a good company . Start explore thousands of jobs in one place.</div>
            ...
            <div className='w-[55%] flex  items-center justify-center'>
                <div className='w-[30rem] relative '>
                    ...
                    <div className='absolute top-[28%] -left-5 w-fit border-bright-sun-400 border rounded-lg p-2 backdrop-blur-md gap-3 flex flex-col ' >
