...
function Working() {
    return (
        <div className='mt-20 pb-5  '>
            <div className=' text-4xl text-center font-semibold mt-10 text-mine-shaft-100  '>
                How it <span className='text-bright-sun-400'>Works</span> </div>
            <div className='text-lg mx-auto mb-10 text-mine-shaft-100 text-center w-1/2 '>
            ...
            <div className=' flex  px-16 justify-between items-center '>
                ...
                <div className='relative  '>
                    ...
                    <div className='w-36 flex flex-col top-[15%] right-0 absolute items-center gap-1 border border-bright-sun-400
