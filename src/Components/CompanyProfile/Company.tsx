    ...
    return (
        ...
        <div className='w-3/4'>
            <div className=' relative ' >
                ...
                <img className=' w-36 h-36  rounded-3xl  -bottom-1/4 p-2 bg-mine-shaft-950 absolute left-3 border-mine-shaft-950 border-8 ' src="/Icons/Google.png" alt="" />
            ...
            <div className='px-3 mt-12 ' >
                ...
                <div className=' flex  gap-1 text-lg items-center text-mine-shaft-300 '>
                    <IconMapPin className='h-5 w-5  ' stroke={1.5} />  New York , United State
                </div>
            </div>
            <Divider mx='xs' my='xl' />
            <div>
