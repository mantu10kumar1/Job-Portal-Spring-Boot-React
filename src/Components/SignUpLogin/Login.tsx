   ...
   const handleChange = (event:any) =>{
      ...
      const handleSubmit = () =>{
        ...
        loginUser(data)
          ...
          .catch((err) => console.log("Error occure while login : " , err?.response?.data));
      }
  return (
    
     <div className='w-1/2  px-20 flex flex-col justify-center gap-3 '>
          <div className='text-2xl font-semibold '>Create Account</div>
            <TextInput value={data.email} onChange={handleChange} name='email' withAsterisk  leftSection={<IconAt style={{width:rem(16), height: rem(16) }} /> }
