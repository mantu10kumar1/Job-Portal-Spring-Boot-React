    ...
    <div className=' w-2/3 '>
      ...
      <div className='px-3 '>
        ...
        <div className='flex flex-wrap gap-2 '>
          {
            props.skills.map((skill: any, index: any) => <div key={index} className='bg-bright-sun-300  bg-opacity-15 text-sm font-medium rounded-3xl text-bright-sun-400 px-3 py-1 '>{skill}</div>)
          }
        </div>
      </div>
      <Divider mx='xs' my='xl' />
