            ...
            <div className='flex justify-between mb-3  '>
                <div className='flex gap-2 items-center '>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <div className='text-lg text-mine-shaft-300 '>{props.company} &#x2022; {props.location} &bull;
                             {timeAgo(props.postTime)} &bull;    {props.applicants?props.applicants.length:0} Applicants</div>
                    </div>
                </div>
            </div>
            <Divider my="xl" />
