...
function Card(props: any) {
    ...
    return (
        <Link to="/jobs" className='bg-mine-shaft-900 p-4 w-80 flex flex-col gap-3 rounded-xl
        hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400 '>
            <div className='flex justify-between  '>
                ...
                {props.saved ? <IconBookmarkFilled className='text-bright-sun-400 cursor-pointer ' /> :
            ...
            <div className='flex justify-between '>
                ...
                <div className=' flex  gap-1 text-xs items-center text-mine-shaft-400 '>
                    <IconClockHour3 className='h-5 w-5  ' stroke={1.5} /> {props.applied || props.interviewing ? "Applied" : props.offered ? "Interviesed" : "Posted"} {props.postedDaysAgo} days ago
                </div>
            </div>
